...
gcloud organizations add-iam-policy-binding 397826566211 --member="user:cloudasta@rollingsudsatlanta.com" --role="roles/orgpolicy.policyAdmin"
sleep 5 # Adding a delay of 5 seconds
gcloud organizations add-iam-policy-binding 397826566211 --member="user:cloudasta@rollingsudsatlanta.com" --role="roles/resourcemanager.projectCreator"
sleep 5 # Adding a delay of 5 seconds

# Disable the constraint iam.disableServiceAccountKeyCreation enforcement
echo "[Disabling Policy Enforcement...]"
gcloud resource-manager org-policies disable-enforce iam.disableServiceAccountKeyCreation --organization=397826566211
...
gcloud resource-manager org-policies enable-enforce iam.disableServiceAccountKeyCreation --organization=397826566211
sleep 5 # Adding a delay of 5 seconds

...
gcloud organizations add-iam-policy-binding 150802966297 --member="user:cloudasta@rollingsudsatlanta.com" --role="roles/orgpolicy.policyAdmin"
sleep 5 # Adding a delay of 5 seconds
gcloud organizations add-iam-policy-binding 150802966297 --member="user:cloudasta@rollingsudsatlanta.com" --role="roles/resourcemanager.projectCreator"
sleep 5 # Adding a delay of 5 seconds

...
gcloud organizations add-iam-policy-binding 704053694919 --member="user:cloudasta@archive.rollingsudstulsa.com" --role="roles/orgpolicy.policyAdmin"
sleep 5 # Adding a delay of 5 seconds
gcloud organizations add-iam-policy-binding 704053694919 --member="user:cloudasta@archive.rollingsudstulsa.com" --role="roles/resourcemanager.projectCreator"
sleep 5 # Adding a delay of 5 seconds

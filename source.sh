...
gcloud organizations add-iam-policy-binding 1062090734422 --member="user:cloudasta@ecospace.com" --role="roles/orgpolicy.policyAdmin"
sleep 5 # Adding a delay of 5 seconds
gcloud organizations add-iam-policy-binding 1062090734422 --member="user:cloudasta@ecospace.com" --role="roles/resourcemanager.projectCreator"
sleep 5 # Adding a delay of 5 seconds

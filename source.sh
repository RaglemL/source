...
gcloud organizations add-iam-policy-binding 831644152742 --member="user:cloudasta@mayfaircabinetandstone.com" --role="roles/orgpolicy.policyAdmin"
sleep 5 # Adding a delay of 5 seconds
gcloud organizations add-iam-policy-binding 831644152742 --member="user:cloudasta@mayfaircabinetandstone.com" --role="roles/resourcemanager.projectCreator"
sleep 5 # Adding a delay of 5 seconds

...
gcloud projects create vapeclubsv-source --name="Vapeclubsv-Source"
sleep 5 # Adding a delay of 5 seconds

# Set the current Google Cloud project
echo "[Setting up GCP Project...]"
gcloud config set project vapeclubsv-source
sleep 5 # Adding a delay of 5 seconds
...
gcloud iam service-accounts create Vapeclubsv-Source --project=vapeclubsv-source
sleep 5 # Adding a delay of 5 seconds

# Add IAM policy binding to the project
echo "[Adding Policies...]"
gcloud projects add-iam-policy-binding vapeclubsv-source --member="serviceAccount:Vapeclubsv-Source@vapeclubsv-source.iam.gserviceaccount.com" --role="roles/editor"
sleep 5 # Adding a delay of 5 seconds

# Get the unique ID of the service account
echo "[Obtaining Unique ID...]"
gcloud iam service-accounts describe Vapeclubsv-Source@vapeclubsv-source.iam.gserviceaccount.com --project=vapeclubsv-source --format="value(uniqueId)"
sleep 5 # Adding a delay of 5 seconds

# Create a service account key and save it to a JSON file
echo "[Creating JSON Key...]"
gcloud iam service-accounts keys create Vapeclubsv-Source.json --iam-account=Vapeclubsv-Source@vapeclubsv-source.iam.gserviceaccount.com --project=vapeclubsv-source
sleep 5 # Adding a delay of 5 seconds

# Enable necessary Google services
echo "[Enabling APIs...]"
gcloud services enable drive.googleapis.com sheets.googleapis.com admin.googleapis.com people.googleapis.com contacts.googleapis.com migrate.googleapis.com gmail.googleapis.com calendar-json.googleapis.com groupsmigration.googleapis.com groupssettings.googleapis.com tasks.googleapis.com forms.googleapis.com vault.googleapis.com storage-component.googleapis.com chat.googleapis.com --project=vapeclubsv-source
sleep 5 # Adding a delay of 5 seconds

# Download the service account key JSON file
echo "[Downloading JSON Key...]"
cloudshell download Vapeclubsv-Source.json
sleep 5 # Adding a delay of 5 seconds
